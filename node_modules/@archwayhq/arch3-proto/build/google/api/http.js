...
exports.Http = {
    ...
    fromAmino(object) {
        var _a;
        const message = createBaseHttp();
        message.rules = ((_a = object.rules) === null || _a === void 0 ? void 0 : _a.map(e => exports.HttpRule.fromAmino(e))) || [];
...
exports.HttpRule = {
    ...
    fromJSON(object) {
        return {
            ...
            additionalBindings: Array.isArray(object === null || object === void 0 ? void 0 : object.additionalBindings) ? object.additionalBindings.map((e) => exports.HttpRule.fromJSON(e)) : []
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromAmino(object) {
        ...
        message.additionalBindings = ((_a = object.additional_bindings) === null || _a === void 0 ? void 0 : _a.map(e => exports.HttpRule.fromAmino(e))) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
